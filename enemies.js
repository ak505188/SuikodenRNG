var enemies = {
  ...
  "PannaYakutaCastle": {
    ...
    "encounters": [
      ...
      { "name": "2 VeteranSoldier(sabre)",
        "parseString": "2 VeteranSoldier(sabre)" },
      { "name": "3 VeteranSoldier(sabre)",
        "parseString": "3 VeteranSoldier(sabre)" },
      { "name": "3 VeteranSoldier(bow)",
        "parseString": "3 VeteranSoldier(bow)" },
      { "name": "1 VeteranSoldier(sabre) 1 VeteranSoldier(spear) 2 VeteranSoldier(bow)",
        "parseString": "1 VeteranSoldier(sabre) 1 VeteranSoldier(spear) 2 VeteranSoldier(bow)" },
      { "name": "1 VeteranSoldier(sabre) 1 VeteranSoldier(spear) 3 VeteranSoldier(bow)",
